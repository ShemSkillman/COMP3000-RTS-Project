...
namespace RTSEngine
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "NewBuildingRegulatorData", menuName = "RTS Engine/NPC Building Regulator Data", order = 53)]
    public class NPCBuildingRegulatorData : NPCRegulatorData
    {
        ...
        private string placementOptionInfo = ""; //only valid when the placement option is set to aroundBuilding (provide building code) or aroundResource (provide resource name).
        public string GetPlacementOptionInfo () { return placementOptionInfo; }
